...
export const EditTransactionModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-t-2xl sm:rounded-2xl max-w-md w-full p-5 sm:p-6 shadow-2xl relative max-h-[92vh] sm:max-h-none overflow-y-auto">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus-within:ring-2 focus-within:ring-emerald-500/50 transition-all">
              ...
              <input
                ...
                required
                className="w-full flex-1 min-w-0 bg-transparent text-slate-800 dark:text-slate-200 font-medium text-sm focus:outline-none cursor-pointer"
              />
            </div>
          </div>
